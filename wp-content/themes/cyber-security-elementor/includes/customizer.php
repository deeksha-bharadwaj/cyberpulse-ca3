...
if ( class_exists("Kirki")){
	...
	Kirki::add_field( 'theme_config_id', [
    'type'     => 'custom',
    'settings' => 'cyber_security_elementor_show_product_featured_image_hover_heading',
    'section'  => 'cyber_security_elementor_woocommerce_settings',
    'default'  => '<h3 style="color: #2271b1; padding:10px; background:#fff; margin:0; border-left: solid 5px #2271b1;">' . __( 'Product Featured Image Hover Effect', 'cyber-security-elementor' ) . '</h3>',
    'priority' => 20,
   ] );

	Kirki::add_field( 'theme_config_id', [
    'type'     => 'select',
    'settings' => 'cyber_security_elementor_product_featured_image_hover',
    'label'    => esc_html__( 'Product Featured Image Hover Effect', 'cyber-security-elementor' ),
    'section'  => 'cyber_security_elementor_woocommerce_settings',
    'default'  => 'none',
    'priority' => 30,
    'choices'  => [
        'none'      => esc_html__( 'None', 'cyber-security-elementor' ),
        'zoom-in'   => esc_html__( 'Zoom In', 'cyber-security-elementor' ),
        'zoom-out'  => esc_html__( 'Zoom Out', 'cyber-security-elementor' ),
        'scale'     => esc_html__( 'Scale', 'cyber-security-elementor' ),
        'grayscale' => esc_html__( 'Grayscale', 'cyber-security-elementor' ),
        'blur'      => esc_html__( 'Blur', 'cyber-security-elementor' ),
        'bright'    => esc_html__( 'Bright', 'cyber-security-elementor' ),
        'sepia'     => esc_html__( 'Sepia', 'cyber-security-elementor' ),
        'translate' => esc_html__( 'Translate', 'cyber-security-elementor' ),
    ],
    ] );
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'custom',
		'tab'         => 'general',
		'settings'    => 'cyber_security_elementor_preloader_type_heading',
		'section'     => 'cyber_security_elementor_additional_setting',
		'default'     => '<h3 style="color: #2271b1; padding:10px; background:#fff; margin:0; border-left: solid 5px #2271b1; ">' . __( 'Select Preloader Type', 'cyber-security-elementor' ) . '</h3>',
	] );
	
	Kirki::add_field( 'theme_config_id', [
		'type'     => 'radio',
		'tab'      => 'general',
		'settings' => 'cyber_security_elementor_preloader_type',
		'section'  => 'cyber_security_elementor_additional_setting',
		'default'  => 'diamond',
		'choices'  => [
			'diamond' => esc_html__( 'Diamond', 'cyber-security-elementor' ),
			'orbit' => esc_html__( 'Orbit Pulse Loader', 'cyber-security-elementor' ),
			'liquid' => esc_html__( 'Liquid Glow Loader', 'cyber-security-elementor' ),
		],
    ] );
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'custom',
		'tab'         => 'general',
		'settings'    => 'cyber_security_elementor_preloader_bg_image_heading',
		'section'     => 'cyber_security_elementor_additional_setting',
		'default'     => '<h3 style="color: #2271b1; padding:10px; background:#fff; margin:0; border-left: solid 5px #2271b1; ">' . __( 'Preloader Background', 'cyber-security-elementor' ) . '</h3>',
		'priority'    => 10,
	] );

	Kirki::add_field( 'theme_config_id',
	[
		'settings'    => 'cyber_security_elementor_preloader_bg_image',
		'tab'         => 'general',
		'type'        => 'background',
		'section'     => 'cyber_security_elementor_additional_setting',
		'default'     => [
	...
	'type'     => 'select',
	'tab'      => 'single-post',
	'settings' => 'cyber_security_elementor_single_post_featured_image_hover',
	'label'    => esc_html__( 'Featured Image Hover Effect', 'cyber-security-elementor' ),
	'section'  => 'cyber_security_elementor_blog_post',
	'default'  => 'none',
	'priority' => 20,
	'choices'  => [
