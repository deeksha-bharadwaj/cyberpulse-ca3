...
?>
<?php 
if( get_theme_mod('cyber_security_elementor_preloader_hide', false ) == true ){ 

	$cyber_security_elementor_type = get_theme_mod('cyber_security_elementor_preloader_type','diamond');
?>
<div class="frame">
	<div class="loader preloader-types">

		<?php if($cyber_security_elementor_type == 'diamond'){ ?>
		...
		<?php } elseif($cyber_security_elementor_type == 'orbit'){ ?>
		...
		<?php } elseif($cyber_security_elementor_type == 'liquid'){ ?>
